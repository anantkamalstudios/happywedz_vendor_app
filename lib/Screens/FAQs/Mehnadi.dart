...
// ===== MEHENDI ARTISTS FAQ SCREEN =====
class MehendiArtistsScreen extends StatefulWidget {
  const MehendiArtistsScreen({super.key});

  @override
  State<MehendiArtistsScreen> createState() =>
      _MehendiArtistsScreenState();
}
...
class _MehendiArtistsScreenState extends State<MehendiArtistsScreen> {
  ...
  Future<void> _init() async {
    ...
    final data = mehendiartistsJson['questions'] as List;
  ...
  Future<void> _fetchFaqAnswers() async {
    ...
    try {
      ...
      debugPrint("❌ Mehendi FAQ fetch error: $e");
    } finally {
      setState(() => isLoading = false);
    }
  }
...
const mehendiartistsJson = {
  ...
  "questions": [
    ...
    },
    {
      "id": 804,
      "text":
      "What is your starting price range for family/guest mehendi?",
      "type": "radio",
      "options": [
        "Under ₹1,000",
        "₹1,000 - ₹2,499",
    ...
    },
    {
      "id": 808,
      "text":
      "Which year did you/your team professionally start providing mehendi services?",
      "type": "number",
      "options": []
    }
  ]
