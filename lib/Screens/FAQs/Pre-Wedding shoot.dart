...
// Not reachable and not imported. The FAQ router
//   (Storefront.faqByVendorTypeId) maps every supported vendor type id to
//   one of the other FAQ screens; no id maps here. Retained because it is a
//   complete, working FAQ screen that only needs a vendor-type id assigned
//   to become live.
//
