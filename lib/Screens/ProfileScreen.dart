...
// Superseded. This is an ENTIRELY MOCK profile module: a pink-themed
//   ProfileScreen showing a hard-coded business name ('Jiya Wedding
//   Planner'), plus PaymentHistoryScreen and MyReviewsScreen whose lists
//   are hard-coded Dart literals presented as real business data (fake
//   vendors, fake amounts, fake dates), an AccountSettingsScreen whose Save
//   button only shows a snackbar, a HelpSupportScreen whose four rows have
//   empty onTap handlers, and a LogoutScreen whose confirm button is a bare
//   'TODO: Perform logout action'. It also references a non-existent asset
//   ('assets/profile.jpg') and names a competitor ('WedMeGood') in
//   user-facing copy. The live equivalents are ReviewsPage (real
//   /api/reviews/my-reviews data) and the logout flow in BusinessDrawer.
//   Commented out so this mock data can never reach a user, while remaining
//   available as a UI reference.
//
